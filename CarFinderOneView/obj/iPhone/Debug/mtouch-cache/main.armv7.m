...
extern void *mono_aot_module_CarFinderOneView_info;
...
{
	mono_aot_register_module (mono_aot_module_CarFinderOneView_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "CarFinderOneView.exe";
	mono_use_llvm = FALSE;
